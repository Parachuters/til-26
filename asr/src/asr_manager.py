...
class ASRManager:
    ...
    def __init__(self):
        ...
        self.no_speech_threshold = float(os.getenv("ASR_NO_SPEECH_THRESHOLD", "0.6"))
    ...
    def asr(self, audio_bytes: bytes) -> str:
        ...
        # Run a cheap beam_size=1 pass just to detect language with high
        # confidence; if confident enough, pass an explicit language hint to
        # the full transcription pass so Whisper skips its internal detector.
        detected_lang = None
        try:
